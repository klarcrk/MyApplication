package app.witness.com.myapplication.countdown;
...
public class CoundDownActivity extends BaseActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.countdown_activity_layout);
    ...
    private void setCountDownViewListener(CountDownView view) {
        ...
        view.setOnTimeListener(new CountDownView.OnTimeListener() {
            ...
            public void onTimeStart() {
                Toast.makeText(CoundDownActivity.this, "count down start", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onTimeEnd() {
                Toast.makeText(CoundDownActivity.this, "count down end", Toast.LENGTH_SHORT).show();
            }
        });
